...
$code = $_POST['code'];
$result = mysqli_query($con,"SELECT * FROM `newproducts` WHERE `code`='$code'");
...
<?php
$result = mysqli_query($con,"SELECT * FROM `newproducts`");
while($row = mysqli_fetch_assoc($result)){
		echo "<div class='product_wrapper'>
              ...
              <button type='submit' class='button3'>Add to cart</button>
			  </form>
		   	  </div>";
        }
mysqli_close($con);
